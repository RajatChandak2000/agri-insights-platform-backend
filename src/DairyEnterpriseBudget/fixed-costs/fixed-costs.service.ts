...
export class FixedCostsService{
    ...
    async calculateFixedCostsOutput(userId: string, updatedDocument: FixedCostsInput) {
        ...
        const articulatedLoadersCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.articulatedLoadersCroppingHoursOfUse;
        ...
        const skidSteerLoadersCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.skidSteerLoadersCroppingHoursOfUse;
        ...
        const hpTractorMFWD130CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.hpTractor130MfwDCroppingHoursOfUse;
        ...
        const hpTractor2wd75CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.hpTractor75CroppingHoursOfUse;
        ...
        const tractor50Hp2wdCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.hpTractor50CroppingHoursOfUse;
        ...
        const mixerWagon650CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.mixerWagon650CroppingHoursOfUse;
        ...
        const threeQuarterTonPickupCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.threeQuarterTonPickupCroppingHoursOfUse;
        ...
        const halfTonPickupCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.halfTonPickupCroppingHoursOfUse;
        ...
        const jdGatorCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.jdGatorCroppingHoursOfUse;
        ...
        const sandSpreaderCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.sandSpreaderCroppingHoursOfUse;
        ...
        const hpTractorMFWD300CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.hpTractor300MfwDCroppingHoursOfUse;
        ...
        const hpTractorMFWD200CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.hpTractor200MfwDCroppingHoursOfUse;
        ...
        const diskHarrow24CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.diskHarrow24CroppingHoursOfUse;
        ...
        const stripTillPlanter8RowCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.stripTillPlanter8RowCroppingHoursOfUse;
        ...
        const foldingSprayer40CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.foldingSprayer40CroppingHoursOfUse;
        ...
        const fieldCultivatorCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.fieldCultivatorCroppingHoursOfUse;
        ...
        const grainDrill15NoTillCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.grainDrill15NoTillCroppingHoursOfUse;
        ...
        const mowerConditionerSelfPropelledCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.mowerConditionerSelfPropelledCroppingHoursOfUse;
        ...
        const tedderCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.tedderCroppingHoursOfUse;
        ...
        const powerRakeCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.powerRakeCroppingHoursOfUse;
        ...
        const foldingRotaryMower15CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.foldingRotaryMower15CroppingHoursOfUse;
        ...
        const deepRipperCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.deepRipperCroppingHoursOfUse;
        ...
        const livestockTrailer24CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.livestockTrailer24CroppingHoursOfUse;
        ...
        const roundBalerCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.roundBalerCroppingHoursOfUse;
        ...
        const tubGrinderCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.tubGrinderCroppingHoursOfUse;
        ...
        const miscellaneousEquipmentCroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.miscellaneousEquipmentCroppingHoursOfUse;
        ...
        const otherMachineryEquipment1CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.otherMachineryEquipment1CroppingHoursOfUse;
        ...
        const otherMachineryEquipment2CroppingHoursOfUse = updatedDocument.detailedMachineryFixedCosts?.otherMachineryEquipment2CroppingHoursOfUse;
        ...
        if(updatedDocument.isDetailedMachineryCosts){
            ...
            const articulatedLoadersEstimatedCurrentSalvageValue = articulatedLoadersInitialInvestment * (ageCategories.get(articulatedLoadersEquipmentAge).Misc / 100);
            const articulatedLoadersEstimatedFinalSalvageValue = articulatedLoadersInitialInvestment * (ageCategories.get(articulatedLoadersYearsOfUsefulLife).Misc / 100);
            ...
            const articulatedLoadersCroppingAnnualEconomicCost = (articulatedLoadersAnnualAmortization + articulatedLoadersPropertyTax + articulatedLoadersPropertyInsurance) * (articulatedLoadersCroppingHoursOfUse / articulatedLoadersTotalHoursOfUse);

            // Skid Steer Loaders
            const skidSteerLoadersInitialInvestment = numberOfSkidSteerLoaders * skidSteerLoadersInitialInvestmentPerUnit;
            const skidSteerLoadersEstimatedCurrentSalvageValue = skidSteerLoadersInitialInvestment * (ageCategories.get(skidSteerLoadersEquipmentAge).Misc / 100);
            const skidSteerLoadersEstimatedFinalSalvageValue = skidSteerLoadersInitialInvestment * (ageCategories.get(skidSteerLoadersYearsOfUsefulLife).Misc / 100);
            ...
            const skidSteerLoadersCroppingAnnualEconomicCost = (skidSteerLoadersAnnualAmortization + skidSteerLoadersPropertyTax + skidSteerLoadersPropertyInsurance) * (skidSteerLoadersCroppingHoursOfUse / skidSteerLoadersTotalHoursOfUse);

            // 130 hp Tractor - MFWD
            const hpTractorMFWD130InitialInvestment = numberOfHpTractorMFWD130 * hpTractorMFWD130InitialInvestmentPerUnit;
            const hpTractorMFWD130EstimatedCurrentSalvageValue = hpTractorMFWD130InitialInvestment * (ageCategories.get(hpTractorMFWD130EquipmentAge).Tractors_80_149hp / 100);
            const hpTractorMFWD130EstimatedFinalSalvageValue = hpTractorMFWD130InitialInvestment * (ageCategories.get(hpTractorMFWD130YearsOfUsefulLife).Tractors_80_149hp / 100);
            ...
            const hpTractorMFWD130CroppingAnnualEconomicCost = (hpTractorMFWD130AnnualAmortization + hpTractorMFWD130PropertyTax + hpTractorMFWD130PropertyInsurance) * (hpTractorMFWD130CroppingHoursOfUse / hpTractorMFWD130TotalHoursOfUse);

            // 75 hp Tractor - 2wd
            const hpTractor2wd75InitialInvestment = numberOfHpTractor2wd75 * hpTractor2wd75InitialInvestmentPerUnit;
            const hpTractor2wd75EstimatedCurrentSalvageValue = hpTractor2wd75InitialInvestment * (ageCategories.get(hpTractor2wd75EquipmentAge).Tractors_80_149hp / 100);
            const hpTractor2wd75EstimatedFinalSalvageValue = hpTractor2wd75InitialInvestment * (ageCategories.get(hpTractor2wd75YearsOfUsefulLife).Tractors_80_149hp / 100);
            ...
            const hpTractor2wd75CroppingAnnualEconomicCost = (hpTractor2wd75AnnualAmortization + hpTractor2wd75PropertyTax + hpTractor2wd75PropertyInsurance) * (hpTractor2wd75CroppingHoursOfUse / hpTractor2wd75TotalHoursOfUse);

            // 50 hp Tractor - 2wd
            const tractor50Hp2wdInitialInvestment = numberOfHpTractor2wd50 * tractor50Hp2wdInitialInvestmentPerUnit;
            const tractor50Hp2wdEstimatedCurrentSalvageValue = tractor50Hp2wdInitialInvestment * (ageCategories.get(hpTractor2wd50EquipmentAge).Tractors_80_149hp / 100);
            const tractor50Hp2wdEstimatedFinalSalvageValue = tractor50Hp2wdInitialInvestment * (ageCategories.get(hpTractor2wd50YearsOfUsefulLife).Tractors_80_149hp / 100);
            ...
            const hpTractor2wd50CroppingAnnualEconomicCost = (tractor50Hp2wdAnnualAmortization + tractor50Hp2wdPropertyTax + tractor50Hp2wdPropertyInsurance) * (tractor50Hp2wdCroppingHoursOfUse / tractor50Hp2wdTotalHoursOfUse);

            // Mixer Wagon - 650 cubic feet
            const mixerWagon650InitialInvestment = numberOfMixerWagon650 * mixerWagon650InitialInvestmentPerUnit;
            const mixerWagon650EstimatedCurrentSalvageValue = mixerWagon650InitialInvestment * (ageCategories.get(mixerWagon650EquipmentAge).Misc / 100);
            const mixerWagon650EstimatedFinalSalvageValue = mixerWagon650InitialInvestment * (ageCategories.get(mixerWagon650YearsOfUsefulLife).Misc / 100);
            const mixerWagon650AnnualAmortization = ((mixerWagon650EstimatedCurrentSalvageValue - mixerWagon650EstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(mixerWagon650YearsOfUsefulLife - mixerWagon650EquipmentAge))) + (mixerWagon650EstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const mixerWagon650CroppingAnnualEconomicCost = (mixerWagon650AnnualAmortization + mixerWagon650PropertyTax + mixerWagon650PropertyInsurance) * (mixerWagon650CroppingHoursOfUse / mixerWagon650TotalHoursOfUse);

            // ¾ ton pickup
            const threeQuarterTonPickupInitialInvestment = numberOfThreeQuarterTonPickup * threeQuarterTonPickupInitialInvestmentPerUnit;
            const threeQuarterTonPickupEstimatedCurrentSalvageValue = threeQuarterTonPickupInitialInvestment * (ageCategories.get(threeQuarterTonPickupEquipmentAge).Misc / 100);
            const threeQuarterTonPickupEstimatedFinalSalvageValue = threeQuarterTonPickupInitialInvestment * (ageCategories.get(threeQuarterTonPickupYearsOfUsefulLife).Misc / 100);
            ...
            const threeQuarterTonPickupCroppingAnnualEconomicCost = (threeQuarterTonPickupAnnualAmortization + threeQuarterTonPickupPropertyTax + threeQuarterTonPickupPropertyInsurance) * (threeQuarterTonPickupCroppingHoursOfUse / threeQuarterTonPickupTotalHoursOfUse);

            // ½ ton pickup
            const halfTonPickupInitialInvestment = numberOfHalfTonPickup * halfTonPickupInitialInvestmentPerUnit;
            const halfTonPickupEstimatedCurrentSalvageValue = halfTonPickupInitialInvestment * (ageCategories.get(halfTonPickupEquipmentAge).Misc / 100);
            const halfTonPickupEstimatedFinalSalvageValue = halfTonPickupInitialInvestment * (ageCategories.get(halfTonPickupYearsOfUsefulLife).Misc / 100);
            ...
            const halfTonPickupCroppingAnnualEconomicCost = (halfTonPickupAnnualAmortization + halfTonPickupPropertyTax + halfTonPickupPropertyInsurance) * (halfTonPickupCroppingHoursOfUse / halfTonPickupTotalHoursOfUse);

            // JD Gator
            const jdGatorInitialInvestment = numberOfJdGator * jdGatorInitialInvestmentPerUnit;
            const jdGatorEstimatedCurrentSalvageValue = jdGatorInitialInvestment * (ageCategories.get(jdGatorEquipmentAge).Misc / 100);
            const jdGatorEstimatedFinalSalvageValue = jdGatorInitialInvestment * (ageCategories.get(jdGatorYearsOfUsefulLife).Misc / 100);
            ...
            const jdGatorCroppingAnnualEconomicCost = (jdGatorAnnualAmortization + jdGatorPropertyTax + jdGatorPropertyInsurance) * (jdGatorCroppingHoursOfUse / jdGatorTotalHoursOfUse);

            // Sand Spreader
            const sandSpreaderInitialInvestment = numberOfSandSpreader * sandSpreaderInitialInvestmentPerUnit;
            const sandSpreaderEstimatedCurrentSalvageValue = sandSpreaderInitialInvestment * (ageCategories.get(sandSpreaderEquipmentAge).Misc / 100);
            const sandSpreaderEstimatedFinalSalvageValue = sandSpreaderInitialInvestment * (ageCategories.get(sandSpreaderYearsOfUsefulLife).Misc / 100);
            ...
            const sandSpreaderCroppingAnnualEconomicCost = (sandSpreaderAnnualAmortization + sandSpreaderPropertyTax + sandSpreaderPropertyInsurance) * (sandSpreaderCroppingHoursOfUse / sandSpreaderTotalHoursOfUse);

            // 300 hp Tractor - MFWD
            const hpTractorMFWD300InitialInvestment = numberOfHpTractorMFWD300 * hpTractorMFWD300InitialInvestmentPerUnit;
            const hpTractorMFWD300EstimatedCurrentSalvageValue = hpTractorMFWD300InitialInvestment * (ageCategories.get(hpTractorMFWD300EquipmentAge).Tractor_150hp / 100);
            const hpTractorMFWD300EstimatedFinalSalvageValue = hpTractorMFWD300InitialInvestment * (ageCategories.get(hpTractorMFWD300YearsOfUsefulLife).Tractor_150hp / 100);
            ...
            const hpTractorMFWD300CroppingAnnualEconomicCost = (hpTractorMFWD300AnnualAmortization + hpTractorMFWD300PropertyTax + hpTractorMFWD300PropertyInsurance) * (hpTractorMFWD300CroppingHoursOfUse / hpTractorMFWD300TotalHoursOfUse);

            // 200 hp Tractor - MFWD
            const hpTractorMFWD200InitialInvestment = numberOfHpTractorMFWD200 * hpTractorMFWD200InitialInvestmentPerUnit;
            const hpTractorMFWD200EstimatedCurrentSalvageValue = hpTractorMFWD200InitialInvestment * (ageCategories.get(hpTractorMFWD200EquipmentAge).Tractor_150hp / 100);
            const hpTractorMFWD200EstimatedFinalSalvageValue = hpTractorMFWD200InitialInvestment * (ageCategories.get(hpTractorMFWD200YearsOfUsefulLife).Tractor_150hp / 100);
            ...
            const hpTractorMFWD200CroppingAnnualEconomicCost = (hpTractorMFWD200AnnualAmortization + hpTractorMFWD200PropertyTax + hpTractorMFWD200PropertyInsurance) * (hpTractorMFWD200CroppingHoursOfUse / hpTractorMFWD200TotalHoursOfUse);

            // 24’ Disk Harrow
            const diskHarrow24InitialInvestment = numberOfDiskHarrow24 * diskHarrow24InitialInvestmentPerUnit;
            const diskHarrow24EstimatedCurrentSalvageValue = diskHarrow24InitialInvestment * (ageCategories.get(diskHarrow24EquipmentAge).Tilage / 100);
            const diskHarrow24EstimatedFinalSalvageValue = diskHarrow24InitialInvestment * (ageCategories.get(diskHarrow24YearsOfUsefulLife).Tilage / 100);
            ...
            const diskHarrow24CroppingAnnualEconomicCost = (diskHarrow24AnnualAmortization + diskHarrow24PropertyTax + diskHarrow24PropertyInsurance) * (diskHarrow24CroppingHoursOfUse / diskHarrow24TotalHoursOfUse);

            // 8-row 30” Strip-Till Planter
            const stripTillPlanter8RowInitialInvestment = numberOfStripTillPlanter8Row * stripTillPlanter8RowInitialInvestmentPerUnit;
            const stripTillPlanter8RowEstimatedCurrentSalvageValue = stripTillPlanter8RowInitialInvestment * (ageCategories.get(stripTillPlanter8RowEquipmentAge).Planters / 100);
            const stripTillPlanter8RowEstimatedFinalSalvageValue = stripTillPlanter8RowInitialInvestment * (ageCategories.get(stripTillPlanter8RowYearsOfUsefulLife).Planters / 100);
            ...
            const stripTillPlanter8RowCroppingAnnualEconomicCost = (stripTillPlanter8RowAnnualAmortization + stripTillPlanter8RowPropertyTax + stripTillPlanter8RowPropertyInsurance) * (stripTillPlanter8RowCroppingHoursOfUse / stripTillPlanter8RowTotalHoursOfUse);

            // 40’ Folding Sprayer
            const foldingSprayer40InitialInvestment = numberOfFoldingSprayer40 * foldingSprayer40InitialInvestmentPerUnit;
            const foldingSprayer40EstimatedCurrentSalvageValue = foldingSprayer40InitialInvestment * (ageCategories.get(foldingSprayer40EquipmentAge).Misc / 100);
            const foldingSprayer40EstimatedFinalSalvageValue = foldingSprayer40InitialInvestment * (ageCategories.get(foldingSprayer40YearsOfUsefulLife).Misc / 100);
            ...
            const foldingSprayer40CroppingAnnualEconomicCost = (foldingSprayer40AnnualAmortization + foldingSprayer40PropertyTax + foldingSprayer40PropertyInsurance) * (foldingSprayer40CroppingHoursOfUse / foldingSprayer40TotalHoursOfUse);
            ...
            const fieldCultivatorAnnualAmortization = (((fieldCultivatorEstimatedCurrentSalvageValue) - (fieldCultivatorEstimatedFinalSalvageValue)) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(fieldCultivatorYearsOfUsefulLife - fieldCultivatorEquipmentAge))) + ((fieldCultivatorEstimatedFinalSalvageValue) * (longTermInterestRate / 100));
            ...
            const fieldCultivatorCroppingAnnualEconomicCost = (fieldCultivatorAnnualAmortization + fieldCultivatorPropertyTax + fieldCultivatorPropertyInsurance) * (fieldCultivatorCroppingHoursOfUse / fieldCultivatorTotalHoursOfUse);
            ...
            const grainDrill15NoTillAnnualAmortization = ((grainDrill15NoTillEstimatedCurrentSalvageValue - grainDrill15NoTillEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(grainDrill15NoTillYearsOfUsefulLife - grainDrill15NoTillEquipmentAge))) + (grainDrill15NoTillEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const grainDrill15NoTillCroppingAnnualEconomicCost = (grainDrill15NoTillAnnualAmortization + grainDrill15NoTillPropertyTax + grainDrill15NoTillPropertyInsurance) * (grainDrill15NoTillCroppingHoursOfUse / grainDrill15NoTillTotalHoursOfUse);
            ...
            const mowerConditionerSelfPropelledEstimatedCurrentSalvageValue = mowerConditionerSelfPropelledInitialInvestment * (ageCategories.get(mowerConditionerSelfPropelledEquipmentAge).HarvestingForage / 100);
            const mowerConditionerSelfPropelledEstimatedFinalSalvageValue = mowerConditionerSelfPropelledInitialInvestment * (ageCategories.get(mowerConditionerSelfPropelledYearsOfUsefulLife).HarvestingForage / 100);
            const mowerConditionerSelfPropelledAnnualAmortization = ((mowerConditionerSelfPropelledEstimatedCurrentSalvageValue - mowerConditionerSelfPropelledEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(mowerConditionerSelfPropelledYearsOfUsefulLife - mowerConditionerSelfPropelledEquipmentAge))) + (mowerConditionerSelfPropelledEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const mowerConditionerSelfPropelledCroppingAnnualEconomicCost = (mowerConditionerSelfPropelledAnnualAmortization + mowerConditionerSelfPropelledPropertyTax + mowerConditionerSelfPropelledPropertyInsurance) * (mowerConditionerSelfPropelledCroppingHoursOfUse / mowerConditionerSelfPropelledTotalHoursOfUse);
            ...
            const tedderAnnualAmortization = ((tedderEstimatedCurrentSalvageValue - tedderEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(tedderYearsOfUsefulLife - tedderEquipmentAge))) + (tedderEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const tedderCroppingAnnualEconomicCost = (tedderAnnualAmortization + tedderPropertyTax + tedderPropertyInsurance) * (tedderCroppingHoursOfUse / tedderTotalHoursOfUse);
            ...
            const powerRakeAnnualAmortization = ((powerRakeEstimatedCurrentSalvageValue - powerRakeEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(powerRakeYearsOfUsefulLife - powerRakeEquipmentAge))) + (powerRakeEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const powerRakeCroppingAnnualEconomicCost = (powerRakeAnnualAmortization + powerRakePropertyTax + powerRakePropertyInsurance) * (powerRakeCroppingHoursOfUse / powerRakeTotalHoursOfUse);
            ...
            const foldingRotaryMower15CroppingAnnualEconomicCost = (foldingRotaryMower15AnnualAmortization + foldingRotaryMower15PropertyTax + foldingRotaryMower15PropertyInsurance) * (foldingRotaryMower15CroppingHoursOfUse / foldingRotaryMower15TotalHoursOfUse);

            // Deep-Ripper
            const deepRipperInitialInvestment = numberOfDeepRipper * deepRipperInitialInvestmentPerUnit;
            const deepRipperEstimatedCurrentSalvageValue = deepRipperInitialInvestment * (ageCategories.get(deepRipperEquipmentAge).Tilage / 100);
            const deepRipperEstimatedFinalSalvageValue = deepRipperInitialInvestment * (ageCategories.get(deepRipperYearsOfUsefulLife).Tilage / 100);
            const deepRipperAnnualAmortization = ((deepRipperEstimatedCurrentSalvageValue - deepRipperEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(deepRipperYearsOfUsefulLife - deepRipperEquipmentAge))) + (deepRipperEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const deepRipperCroppingAnnualEconomicCost = (deepRipperAnnualAmortization + deepRipperPropertyTax + deepRipperPropertyInsurance) * (deepRipperCroppingHoursOfUse / deepRipperTotalHoursOfUse);

            // 24’ Livestock Trailer
            const livestockTrailer24InitialInvestment = numberOfLivestockTrailer24 * livestockTrailer24InitialInvestmentPerUnit;
            const livestockTrailer24EstimatedCurrentSalvageValue = livestockTrailer24InitialInvestment * (ageCategories.get(livestockTrailer24EquipmentAge).Misc / 100);
            const livestockTrailer24EstimatedFinalSalvageValue = livestockTrailer24InitialInvestment * (ageCategories.get(livestockTrailer24YearsOfUsefulLife).Misc / 100);
            ...
            const livestockTrailer24CroppingAnnualEconomicCost = (livestockTrailer24AnnualAmortization + livestockTrailer24PropertyTax + livestockTrailer24PropertyInsurance) * (livestockTrailer24CroppingHoursOfUse / livestockTrailer24TotalHoursOfUse);
            ...
            const roundBalerAnnualAmortization = ((roundBalerEstimatedCurrentSalvageValue - roundBalerEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(roundBalerYearsOfUsefulLife - roundBalerEquipmentAge))) + (roundBalerEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const roundBalerCroppingAnnualEconomicCost = (roundBalerAnnualAmortization + roundBalerPropertyTax + roundBalerPropertyInsurance) * (roundBalerCroppingHoursOfUse / roundBalerTotalHoursOfUse);
            ...
            const tubGrinderAnnualAmortization = ((tubGrinderEstimatedCurrentSalvageValue - tubGrinderEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(tubGrinderYearsOfUsefulLife - tubGrinderEquipmentAge))) + (tubGrinderEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const tubGrinderCroppingAnnualEconomicCost = (tubGrinderAnnualAmortization + tubGrinderPropertyTax + tubGrinderPropertyInsurance) * (tubGrinderCroppingHoursOfUse / tubGrinderTotalHoursOfUse);
            ...
            const miscellaneousEquipmentEstimatedCurrentSalvageValue = miscellaneousEquipmentInitialInvestment * (ageCategories.get(miscellaneousEquipmentEquipmentAge).Misc / 100);
            const miscellaneousEquipmentEstimatedFinalSalvageValue = miscellaneousEquipmentInitialInvestment * (ageCategories.get(miscellaneousEquipmentYearsOfUsefulLife).Misc / 100);
            const miscellaneousEquipmentAnnualAmortization = ((miscellaneousEquipmentEstimatedCurrentSalvageValue - miscellaneousEquipmentEstimatedFinalSalvageValue) * (longTermInterestRate / 100)) / (1 - Math.pow(1 + (longTermInterestRate / 100), -(miscellaneousEquipmentYearsOfUsefulLife - miscellaneousEquipmentEquipmentAge))) + (miscellaneousEquipmentEstimatedFinalSalvageValue * (longTermInterestRate / 100));
            ...
            const miscellaneousEquipmentCroppingAnnualEconomicCost = (miscellaneousEquipmentAnnualAmortization + miscellaneousEquipmentPropertyTax + miscellaneousEquipmentPropertyInsurance) * (miscellaneousEquipmentCroppingHoursOfUse / miscellaneousEquipmentTotalHoursOfUse);
            ...
            const otherMachineryEquipment1EstimatedCurrentSalvageValue = otherMachineryEquipment1InitialInvestment * (ageCategories.get(otherMachineryEquipment1EquipmentAge).Misc / 100);
            const otherMachineryEquipment1EstimatedFinalSalvageValue = otherMachineryEquipment1InitialInvestment * (ageCategories.get(otherMachineryEquipment1YearsOfUsefulLife).Misc / 100);
            ...
            const otherMachineryEquipment1CroppingAnnualEconomicCost = (otherMachineryEquipment1AnnualAmortization + otherMachineryEquipment1PropertyTax + otherMachineryEquipment1PropertyInsurance) * (otherMachineryEquipment1CroppingHoursOfUse / otherMachineryEquipment1TotalHoursOfUse);
            ...
            const otherMachineryEquipment2EstimatedCurrentSalvageValue = otherMachineryEquipment2InitialInvestment * (ageCategories.get(otherMachineryEquipment2EquipmentAge).Misc / 100);
            const otherMachineryEquipment2EstimatedFinalSalvageValue = otherMachineryEquipment2InitialInvestment * (ageCategories.get(otherMachineryEquipment2YearsOfUsefulLife).Misc / 100);
            ...
            const otherMachineryEquipment2CroppingAnnualEconomicCost = (otherMachineryEquipment2AnnualAmortization + otherMachineryEquipment2PropertyTax + otherMachineryEquipment2PropertyInsurance) * (otherMachineryEquipment2CroppingHoursOfUse / otherMachineryEquipment2TotalHoursOfUse);

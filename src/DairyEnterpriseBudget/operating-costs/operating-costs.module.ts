...
import {
  OperatingCostsInput,
  OperatingCostsInputSchema,
} from '../schemas/inputs/OperatingCostsInput.schema';
import {
  OperatingCostsOutput,
  OperatingCostsOutputSchema,
} from '../schemas/outputs/OperatingCostsOutput.schema';
...
import {
  LabourCostInput,
  LabourCostInputsSchema,
} from '../schemas/inputs/LabourInput.schema';
import {
  LabourCostOutput,
  LabourCostOutputsSchema,
} from '../schemas/outputs/LabourOutput.schema';
